...
static const struct clock_config stm32mp13_clock_cfg[] = {
	...
	PCLK(SPI1, "spi1", IDX_PCLK2, 0, GATE_SPI1, SECF_NONE),
	PCLK(SPI2, "spi2", IDX_PCLK1, 0, GATE_SPI2, SECF_NONE),
	PCLK(SPI3, "spi3", IDX_PCLK1, 0, GATE_SPI3, SECF_NONE),
	PCLK(SPI4, "spi4", IDX_PCLK6, 0, GATE_SPI4, SECF_SPI4),
	PCLK(SPI5, "spi5", IDX_PCLK6, 0, GATE_SPI5, SECF_SPI5),
